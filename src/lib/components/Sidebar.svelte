    ...
    <div class="absolute flex flex-col top-14 left-0 w-64 bg-blue-700 dark:bg-gray-700 h-full text-white transition-all duration-300 border-none z-10 sidebar" style={isSidebar ? "transform: translateX(0)" : "transform: translateX(-100%)"}>
        <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
          <ul class="flex flex-col py-4 space-y-1">
            ...
            <li>
              <a href="/" on:click={() => onSideBar(ALL)} class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
