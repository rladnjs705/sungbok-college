    ...
    <div class="absolute flex flex-col top-14 left-0 w-64 bg-blue-800 dark:bg-gray-700 h-full text-white transition-all duration-300 border-none z-10 sidebar" style={isSidebar ? "transform: translateX(0)" : "transform: translateX(-100%)"}>
        <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
          <ul class="flex flex-col py-4 space-y-1">
            ...
            <li>
              <a href="/notice" on:click={() => onSideBar(NOTICE)} class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6" class:border-blue-500={$itemFooterSelected===NOTICE} class:text-white-800={$itemFooterSelected===NOTICE} class:bg-blue-500={$itemFooterSelected===NOTICE}>
                <span class="inline-flex justify-center items-center ml-4">
            ...
            <li>
              <a href="/questions" on:click={() => onSideBar(QUESTIONS)} class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6" class:border-blue-500={$itemFooterSelected===QUESTIONS} class:text-white-800={$itemFooterSelected===QUESTIONS} class:bg-blue-500={$itemFooterSelected===QUESTIONS}>
                <span class="inline-flex justify-center items-center ml-4">
            ...
            <li>
              <a href="/reportCard" on:click={() => onSideBar(REPORTCARD)} class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6" class:border-blue-500={$itemFooterSelected===REPORTCARD} class:text-white-800={$itemFooterSelected===REPORTCARD} class:bg-blue-500={$itemFooterSelected===REPORTCARD}>
                <span class="inline-flex justify-center items-center ml-4">
            ...
            <li>
              <a href="/free" on:click={() => onSideBar(FREE)} class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6" class:border-blue-500={$itemFooterSelected===FREE} class:text-white-800={$itemFooterSelected===FREE} class:bg-blue-500={$itemFooterSelected===FREE}>
                <span class="inline-flex justify-center items-center ml-4">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"></path></svg>
                </span>
