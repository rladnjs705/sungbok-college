...
<div class="flex justify-center px-6 pb-16 mt-2">
    <div class="w-full max-w-md">
        ...
        <div class="mx-4 sm:mx-0">
            <!-- <div class="mt-8">
                <span class="text-sm font-medium">SNS 회원가입</span>
                <div class="mt-1 grid grid-cols-3 gap-3">
                    <div>
                        <a
                            class="inline-flex w-full justify-center rounded-md border border-gray-500/30 px-4 py-2 text-gray-700 shadow-sm hover:border-gray-500 dark:bg-gray-700 dark:text-gray-300"
                    ...
                    <div>
                        <a
                            ...
                            ><span class="sr-only">Sign in with Naver</span><svg
                                class="h-5 w-5"
                                viewBox="-1 -1 17 16"
                                fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div>
                        <a
                            ...
                            ><span class="sr-only">Sign in with Kakao</span><svg
                                class="h-5 w-5"
                                viewBox="0 0 22 21"
                                fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="relative my-6">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="bg-white px-2 text-gray-500 dark:bg-gray-800">회원가입에 필요한 기본정보를 입력해주세요.</span>
                </div>
            </div>
                ...
                <div>
                    <div class="space-y-6 rounded-md shadow-sm">
                        <div>
                            ...
                            {#if errors.email}
                                <span class:text-red-500={errors.email} class:text-sm={errors.email}>{errors.email}</span>
                            {/if}   
                        </div>
                        <div>
                            <label
                            ...
                            {#if errors.pwd}
                                <span class:text-red-500={errors.pwd} class:text-sm={errors.pwd}>{errors.pwd}</span>
                            {/if}        
                        </div>
                        <div>
                            <label
                            ...
                            {#if errors.pwdConfirm}
                                <span class:text-red-500={errors.pwdConfirm} class:text-sm={errors.pwdConfirm}>{errors.pwdConfirm}</span>
                            {/if}      
                        </div>
                        <div>
                            <label
                            ...
                            <div class="mt-1">
                                <input
                                    ...
                                    class:inputError={errors.userName}
                                    on:keydown={clearError}
                                />
                            </div>
                            {#if errors.userName}
                                <span class:text-red-500={errors.userName} class:text-sm={errors.userName}>{errors.userName}</span>
                            {/if}          
                        </div>
                        <div>
                            <label
                            ...
                            <div class="mt-1">
                                <input
                                    ...
                                    class:inputError={errors.nickName}
                                    on:keydown={clearError}
                                />
                            </div>
                            {#if errors.nickName}
                                <span class:text-red-500={errors.nickName} class:text-sm={errors.nickName}>{errors.nickName}</span>
                            {/if} 
                        </div>
                    </div>
                </div>
